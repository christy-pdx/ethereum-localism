...
In cosmo-localism, bioregionalism is not isolationist, but **relational and networked** (GFEL Boulder Opening).
...
It shifts the economic emphasis from transaction to **relationship** and from profit to **cooperative care** (Grassroots Economics Foundation).
...
**Key Sources:** Michel Bauwens, P2P Foundation; [GFEL Boulder](library/GFEL/GFEL-2025-Boulder-Documentation)

---

## DAO
A **Decentralized Autonomous Organization** is a member-owned, member-governed group without centralized control. DAOs use blockchain-based rules and smart contracts to coordinate decision-making, treasury management, and collective action. In Ethereum Localism, local DAOs often focus on community-scale governance, mutual aid distribution, and place-based coordination—combining Web3 tooling with IRL relationships and accountability.

**See also:** [Fun DAO](library/Implementation-Guides/Fun-DAO) for a low-barrier local DAO example.

---

## Extitution
An organizational form that **appears institutional** (business, nonprofit, government office) but is oriented toward **open protocols and commons** rather than enclosure or profit. Extitutions "hijack instruments of enclosure" to protect and propagate free, permissionless knowledge and practice. They often operate at the edges of legibility, balancing standardization demands with experimentation.

**Key Sources:** Primavera de Filippi, Jessy Kate Schingler; [An Introduction to Open Protocols](library/Extitutions-and-Open-Protocols/An-Introduction-to-Open-Protocols)
...
## Mutual Aid
A practice of **collective care and resource-sharing** based on solidarity rather than charity or exchange. Mutual aid networks organize horizontally to meet community needs—from disaster relief to ongoing support—and build lasting relationships of reciprocity. In Ethereum Localism, mutual aid is both an end (strengthening local bonds) and a coordination challenge that Web3 tools can help address transparently and inclusively.
...
**See also:** Mythic Infrastructure, Meta-Narrative Ecology (GFEL Boulder Narrative Shifts Discussion).
...
**Related terms:** Bioregionalism, Circular Economies, Ecological Restoration. See the [BioFi Project](library/Implementation-Guides/BioFi-Project) for bioregional financing applications.
